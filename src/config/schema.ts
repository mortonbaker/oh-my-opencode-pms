...
export const ManualPlanSchema = z
  .object({
    'project-manager': ManualAgentPlanSchema,
    architect: ManualAgentPlanSchema,
    builder: ManualAgentPlanSchema,
    judge: ManualAgentPlanSchema,
    'qa-reviewer': ManualAgentPlanSchema,
...
const FallbackChainsSchema = z
  .object({
    'project-manager': AgentModelChainSchema.optional(),
    architect: AgentModelChainSchema.optional(),
    builder: AgentModelChainSchema.optional(),
    judge: AgentModelChainSchema.optional(),
    'qa-reviewer': AgentModelChainSchema.optional(),
